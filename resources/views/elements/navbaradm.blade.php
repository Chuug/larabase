<header class="topbar bg-adm"> 
    ...
    <div class="topbar-right">
        <i id="navigation-icon" class="d-none icon-responsive @if(Auth::check()) icon-responsive-connected @else icon-responsive-disconnected @endif text-light fa fa-lg fa-bars"></i>
        @if (!Auth::check())
